              ...
              <ul className="space-y-2 max-h-[60vh] overflow-y-auto custom-scrollbar pr-1">
                {sections.map((section) => (
                  <li key={section.id}>
                    ...
                    >
                      <ChevronRight className={`w-3 h-3 mr-1 transition-transform duration-200 ${activeSection === section.id ? 'rotate-90 text-green-500' : 'text-gray-500'}`} />
          ...
          <div className="lg:col-span-3">
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <p className="border-l-4 border-green-500 pl-4 py-1 font-semibold italic text-sm">
              ...
              <section id="definitions" className="scroll-mt-28 space-y-6">
                ...
                <p>For the purpose of clarity, consistency, and interpretation, the following terms shall have the meanings assigned below:</p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  {[
                    ...
                    { term: "Eco-Points", text: "Non-monetary digital incentive credits awarded for recycling. They have no cash value, are non-transferable, and cannot be converted to legal currency." },
              ...
              <section id="eligibility" className="scroll-mt-28 space-y-4">
                ...
                <ul className="space-y-3">
                  <li>
                    <strong>2.1 Minimum Requirements:</strong> To use SpareXchange, you must be legally capable of entering digital contracts under applicable laws, provide complete and truthful registration info, and use the platform in full compliance with Ethiopian laws and regulations.
                  </li>
                  <li>
                    <strong>2.2 Account Responsibility:</strong> Users are solely responsible for activities performed under their account. You must maintain the confidentiality of login details and notify us immediately of unauthorized access.
                  </li>
                  <li>
                    <strong>2.3 Verification Eligibility:</strong> Access to features like listing parts, technician requests, and eco-point redemption may require completing identity or professional verification.
                  </li>
                  <li>
                    <strong>2.4 Restricted Access:</strong> We reserve the right to suspend or block access if false documents are submitted, fraud is suspected, platform rules are breached, or security concerns arise.
                  </li>
                  <li>
                    <strong>2.5 Geographic Scope:</strong> SpareXchange is designed for use within Ethiopia. Services and availability vary depending on regional infrastructure and operational feasibility.
                  </li>
                </ul>
              </section>
              ...
              <section id="registration" className="scroll-mt-28 space-y-6">
                ...
                <div className="space-y-4">
                  <div>
                    <h3 className={`text-lg font-bold mb-2 ${darkMode ? 'text-white' : 'text-gray-800'}`}>3.1 Registration & Credentials</h3>
                  ...
                  <div>
                    <h3 className={`text-lg font-bold mb-2 ${darkMode ? 'text-white' : 'text-gray-800'}`}>3.2 Account Categories</h3>
                    <ul className="list-disc list-inside space-y-1.5 text-sm ml-2">
                      <li><strong>Standard User:</strong> Can search listings, browse spares, request technicians, recycle items, and submit disputes.</li>
                      <li><strong>Verified User:</strong> Can additionally list parts for exchange and earn/redeem Eco-Points.</li>
                      <li><strong>Technician:</strong> Can accept repair requests, manage availability, and offer technical assistance.</li>
                      <li><strong>Recycler:</strong> Can validate submissions, manage eco-point workflows, and handle scrap.</li>
                      <li><strong>Administrator:</strong> Possesses elevated system rights for moderation, validation, security, and dispute resolution.</li>
                    </ul>
                  </div>

                  <div>
                    <h3 className={`text-lg font-bold mb-2 ${darkMode ? 'text-white' : 'text-gray-800'}`}>3.3 Verification Process & Review</h3>
                    <p>
              ...
              <section id="responsibilities" className="scroll-mt-28 space-y-4">
                ...
                <p>Users agree to act in good faith, legally, and respectfully:</p>
              ...
              <section id="conduct" className="scroll-mt-28 space-y-4">
                ...
                <p>Users must not engage in harmful behavior:</p>
                <ul className="list-disc list-inside space-y-1.5 text-sm ml-2">
                  <li><strong>Fraud:</strong> Creating fake accounts, forging papers, lying about listings, or falsifying skill credentials.</li>
                  <li><strong>Abuse:</strong> Harassment, threats, hate speech, bullying, or discrimination.</li>
                  <li><strong>Technical Malice:</strong> Introducing malware, attempting unauthorized system access, scraping data, or reverse engineering the software.</li>
                  <li><strong>System Abuse:</strong> Submitting fake disputes, fabricating evidence, or cheating the Eco-Points system.</li>
                  <li><strong>Intellectual Property:</strong> Posting images or data violating third-party copyrights or licenses.</li>
                </ul>
              </section>
              ...
              <section id="contact" className="scroll-mt-28 space-y-4">
                ...
                <p>For support, appeals, or questions regarding platform rules, please contact us through official channels:</p>
                <div className={`p-6 rounded-xl border ${darkMode ? 'bg-gray-800/40 border-gray-700' : 'bg-gray-50 border-gray-200'} space-y-2`}>
                  <p><strong>Email Support:</strong> support@sparexchange.com</p>
                  <p><strong>Official Website:</strong> www.sparexchange.com</p>
                  <p><strong>Corporate Address:</strong> Addis Ababa, Ethiopia</p>
                </div>
