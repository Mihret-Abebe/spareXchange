		...
		<div className='min-h-screen bg-background py-8 px-4'>
			<div className='max-w-4xl mx-auto'>
				...
				<div className='grid grid-cols-1 md:grid-cols-3 gap-6 mb-8'>
					<StatCard icon={Users} label='Active Recyclers' value={leaderboard.length + 100 + "+"} />
					<StatCard icon={Award} label='Awards Given' value='1,240' color='text-emerald-500' />
					<StatCard icon={TrendingUp} label='Monthly Growth' value='+12%' color='text-blue-500' />
				</div>
										...
										{filteredLeaderboard.map((entry, index) => (
											<motion.tr
												...
												className={`group transition-colors duration-200 ${
													entry._id === user?._id ? "bg-green-500 bg-opacity-5" : "hover:bg-gray-800 hover:bg-opacity-50"
												}`}
											>
