...
const AdminItemListingsPage = () => {
  ...
  return (
    <motion.div
      ...
      className='min-h-screen bg-gradient-to-b from-gray-900 via-purple-900 to-indigo-900 py-8 px-4'
    >
      <div className='max-w-7xl mx-auto'>
        ...
        <div className='mb-8'>
          ...
          <p className='text-gray-300'>Manage and moderate all marketplace listings</p>
        </div>
          ...
          {showFilters && (
            ...
            >
              <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4'>
                ...
                <div>
                  <label className='block text-white text-sm font-semibold mb-2'>Condition</label>
                  <select
                    name='condition'
                ...
                <div>
                  <label className='block text-white text-sm font-semibold mb-2'>Availability</label>
                  <select
                    name='available'
        ...
        <div className='mb-4'>
          <p className='text-gray-300'>
            Showing <span className='text-purple-400 font-semibold'>{listings.length}</span> listing{listings.length !== 1 ? 's' : ''}
          </p>
        </div>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6'>
            {listings.map((listing, index) => (
              <motion.div
                ...
                className='bg-gray-800 bg-opacity-80 backdrop-filter backdrop-blur-lg rounded-xl border border-gray-700 hover:border-purple-600 transition duration-200 overflow-hidden'
              >
                {/* Image */}
                ...
                <div className='p-4'>
                  ...
                  <p className='text-purple-400 text-xl font-bold mb-2'>${listing.price}</p>
                  ...
                  {listing.seller && (
                    <div className='bg-gray-700 bg-opacity-50 rounded-lg p-3 mb-3'>
                      <div className='flex items-center gap-2 mb-2'>
                        ...
                        <span className='text-white font-semibold text-sm'>{listing.seller.name}</span>
                      ...
                      <div className='text-xs text-gray-400 space-y-1'>
                        ...
                        <p className='flex items-center justify-between'>
                          ...
                          <span className={listing.seller.verifiedSeller ? 'text-green-400' : 'text-yellow-400'}>
